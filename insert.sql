...
-- Insert Transactions
INSERT INTO Transactions (UserID, EntityID, Amount, Date, Description, CategoryID, CategoryName) VALUES
(1, 1, 150.75, GETDATE(), 'Zakup sprzêtu', 1, 'Sprzêt'),
(2, 2, 200.00, GETDATE(), 'Op³ata za us³ugi', 2, 'Us³ugi');

-- Insert Labels
INSERT INTO Labels (LabelName, EntityType, EntityID) VALUES
('Label1', 'Transaction', 1),
('Label2', 'Transaction', 2);
...
-- Insert Reminders
INSERT INTO Reminders (UserID, ExpenseID, Frequency, NextReminderDate, Description) VALUES
(1, 1, 'Monthly', DATEADD(month, 1, GETDATE()), 'Rent payment'),
(2, 2, 'Yearly', DATEADD(year, 1, GETDATE()), 'Insurance payment');
